...
## Project Structure
    ...
    ├── testapiautosetting_116227  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_116227`
...
2. Clone this repo and `cd testapiautosetting_116227`
